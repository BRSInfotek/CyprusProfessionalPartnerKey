...
public class ConfigurationData
{
    ...
    /** Tomcat            */
	protected static String APPSTYPE_TOMCAT = "tomcat"; // Added by Mukesh @20240809
	
	/** WildFly            */
	protected static String APPSTYPE_WILDFLY = "wildfly"; // Added by Mukesh @20240823
	
	/** Application Server Type		*/
	static String[]	APPSTYPE = new String[]
		{ APPSTYPE_JBOSS,
		  APPSTYPE_TOMCAT,			// Added by Mukesh @20240809
		  APPSTYPE_WILDFLY			// Added by Mukesh @20240823		
