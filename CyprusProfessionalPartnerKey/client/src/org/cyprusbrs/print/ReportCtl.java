...
public class ReportCtl
{
	 ...
	 * 	@return true if success
	 */
	public static ReportEngine startDocumentPrint( Properties ctx, int type, int Record_ID, boolean IsDirectPrint, boolean IsShowError )
	{
	 ...
	 *  @return true if OK
	 */
	static public ReportEngine startStandardReport( Properties ctx, ProcessInfo pi, boolean IsDirectPrint )
	{
	 ...
	 * 	@return true if success
	 */
	public static ReportEngine startDocumentPrint( Properties ctx, int type, int Record_ID, boolean IsDirectPrint )
	{
