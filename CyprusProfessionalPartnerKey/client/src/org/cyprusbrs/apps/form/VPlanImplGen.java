 ...
 * 
 */
public class VPlanImplGen extends InOutGen implements FormPanel, ActionListener, VetoableChangeListener
{
	...
	/**	Logger			*/
	private static CLogger log = CLogger.getCLogger(VPlanImplGen.class);
	//
