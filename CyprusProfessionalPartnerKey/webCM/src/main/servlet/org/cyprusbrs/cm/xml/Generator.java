...
import org.cyprusbrs.framework.MAd;
import org.cyprusbrs.framework.MBPBankAccount;
...
import org.cyprusbrs.framework.MNewsChannel;
import org.cyprusbrs.framework.MTemplate;
import org.cyprusbrs.framework.MUser;
import org.cyprusbrs.framework.X_CM_Container_Element;
import org.cyprusbrs.framework.X_CM_NewsChannel;
import org.cyprusbrs.framework.X_CM_TemplateTable;
	...
	private void genTable(String tableName, String whereClause, boolean completeXML, Properties ctx, WebInfo wi) {
		...
		if (l_nTableIDs.length > 0) {
			...
			// else only append ID and DisplayName
				...
				ResultSet rs = null;
				try {
					 pstm = DB.prepareStatement(sql, l_szTrxName);
