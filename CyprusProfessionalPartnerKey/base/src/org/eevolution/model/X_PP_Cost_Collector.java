...
// 0
	...
	/** Operation Execution = 170 */
	public static final String COSTCOLLECTORTYPE_OperationExecution = "170";
	/** Assembly Transfer = 180 */
	public static final String COSTCOLLECTORTYPE_AssemblyTransfer = "180";
	...
	/** Set Operation From.
		@param M_Operation_ID Operation From	  */
	...
	public I_M_Operation getM_OperationRef() throws RuntimeException
    {
		return (I_M_Operation)MTable.get(getCtx(), I_M_Operation.Table_Name)
			.getPO(getM_OperationRef_ID(), get_TrxName());	}

	/** Set Operation To.
		@param M_OperationRef_ID Operation To	  */
	public void setM_OperationRef_ID (int M_OperationRef_ID)
	{
		if (M_OperationRef_ID < 1) 
			set_Value (COLUMNNAME_M_OperationRef_ID, null);
		else 
			set_Value (COLUMNNAME_M_OperationRef_ID, Integer.valueOf(M_OperationRef_ID));
	}

	/** Get Operation To.
		@return Operation To	  */
	public int getM_OperationRef_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_M_OperationRef_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	public org.eevolution.model.I_PP_Order_Node getPP_Order_NodeRef() throws RuntimeException
    {
		return (org.eevolution.model.I_PP_Order_Node)MTable.get(getCtx(), org.eevolution.model.I_PP_Order_Node.Table_Name)
			.getPO(getPP_Order_NodeRef_ID(), get_TrxName());	}

	/** Set Activity To.
		@param PP_Order_NodeRef_ID Activity To	  */
	public void setPP_Order_NodeRef_ID (int PP_Order_NodeRef_ID)
	{
		if (PP_Order_NodeRef_ID < 1) 
			set_Value (COLUMNNAME_PP_Order_NodeRef_ID, null);
		else 
			set_Value (COLUMNNAME_PP_Order_NodeRef_ID, Integer.valueOf(PP_Order_NodeRef_ID));
	}

	/** Get Activity To.
		@return Activity To	  */
	public int getPP_Order_NodeRef_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_PP_Order_NodeRef_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	/** StepFrom AD_Reference_ID=1000054 */
	public static final int STEPFROM_AD_Reference_ID=1000054;
	/** Queue = QU */
	public static final String STEPFROM_Queue = "QU";
	/** In-Progress = IP */
	public static final String STEPFROM_In_Progress = "IP";
	/** Finish = FH */
	public static final String STEPFROM_Finish = "FH";
	/** Set Step From.
	...
	/** StepTo AD_Reference_ID=1000054 */
	public static final int STEPTO_AD_Reference_ID=1000054;
	/** Queue = QU */
	public static final String STEPTO_Queue = "QU";
	/** In-Progress = IP */
	public static final String STEPTO_In_Progress = "IP";
	/** Finish = FH */
	public static final String STEPTO_Finish = "FH";
	/** Set Step To.
		@param StepTo Step To	  */
	...
	{
		set_Value (COLUMNNAME_TrxCost, TrxCost);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_TrxCost);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
