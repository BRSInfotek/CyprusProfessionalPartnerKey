...
import org.cyprusbrs.framework.I_M_ChangeNotice;
...
/** Generated Model for PP_Component_BOMLine
 *  @author Adempiere (generated) 
 *  @version Release 1.0 Supported By Cyprus ERP - $Id$ */
public class X_PP_Component_BOMLine extends PO implements I_PP_Component_BOMLine, I_Persistent 
{
    ...
    public X_PP_Component_BOMLine (Properties ctx, int PP_Component_BOMLine_ID, String trxName)
    {
      super (ctx, PP_Component_BOMLine_ID, trxName);
      /** if (PP_Component_BOMLine_ID == 0)
        {
			setC_UOM_ID (0);
			setIsCritical (false);
// N
...
// @#Date@
    ...
    /** Load Constructor */
    public X_PP_Component_BOMLine (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_PP_Component_BOMLine[")
	...
	/** Set Manufacturing Component BOM Line ID.
		@param PP_Component_BOMLine_ID Manufacturing Component BOM Line ID	  */
	public void setPP_Component_BOMLine_ID (int PP_Component_BOMLine_ID)
	{
		if (PP_Component_BOMLine_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_PP_Component_BOMLine_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_PP_Component_BOMLine_ID, Integer.valueOf(PP_Component_BOMLine_ID));
	}

	/** Get Manufacturing Component BOM Line ID.
		@return Manufacturing Component BOM Line ID	  */
	public int getPP_Component_BOMLine_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_PP_Component_BOMLine_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
