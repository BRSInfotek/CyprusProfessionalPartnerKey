...
/** Generated Model for PP_Cost_CollectorLine
 *  @author Adempiere (generated) 
 *  @version Release 1.0 Supported By Cyprus ERP - $Id$ */
public class X_PP_Cost_CollectorLine extends PO implements I_PP_Cost_CollectorLine, I_Persistent 
{
    ...
    public X_PP_Cost_CollectorLine (Properties ctx, int PP_Cost_CollectorLine_ID, String trxName)
    {
      super (ctx, PP_Cost_CollectorLine_ID, trxName);
      /** if (PP_Cost_CollectorLine_ID == 0)
        {
			setLine (0);
// @SQL=SELECT COALESCE(MAX(Line),0)+10 AS DefaultValue FROM PP_Cost_CollectorLine WHERE PP_Cost_Collector_ID=@PP_Cost_Collector_ID@
			setPP_Cost_CollectorLine_ID (0);
        } */
    }

    /** Load Constructor */
    public X_PP_Cost_CollectorLine (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_PP_Cost_CollectorLine[")
	...
	/** Set Manufacturing Cost Collector Line ID.
		@param PP_Cost_CollectorLine_ID Manufacturing Cost Collector Line ID	  */
	public void setPP_Cost_CollectorLine_ID (int PP_Cost_CollectorLine_ID)
	{
		if (PP_Cost_CollectorLine_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_PP_Cost_CollectorLine_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_PP_Cost_CollectorLine_ID, Integer.valueOf(PP_Cost_CollectorLine_ID));
	}

	/** Get Manufacturing Cost Collector Line ID.
		@return Manufacturing Cost Collector Line ID	  */
	public int getPP_Cost_CollectorLine_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_PP_Cost_CollectorLine_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	public I_PP_Cost_CollectorLine getReversalLine() throws RuntimeException
    {
		return (I_PP_Cost_CollectorLine)MTable.get(getCtx(), I_PP_Cost_CollectorLine.Table_Name)
