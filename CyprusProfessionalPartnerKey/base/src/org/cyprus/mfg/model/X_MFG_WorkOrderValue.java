...
/** Generated Model for MFG_WorkOrderValue
 *  @author Adempiere (generated) 
 *  @version Release 1.1 Supported By Cyprus - $Id$ */
public class X_MFG_WorkOrderValue extends PO implements I_MFG_WorkOrderValue, I_Persistent 
{

	/**
	 *
	 */
	private static final long serialVersionUID = 20211223L;

    /** Standard Constructor */
    public X_MFG_WorkOrderValue (Properties ctx, int MFG_WorkOrderValue_ID, String trxName)
    {
      super (ctx, MFG_WorkOrderValue_ID, trxName);
      /** if (MFG_WorkOrderValue_ID == 0)
        {
        } */
    }

    /** Load Constructor */
    public X_MFG_WorkOrderValue (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_MFG_WorkOrderValue[")
...
//	public static final String DOCSTATUS_Drafted = "D";
	...
	public void setMFG_WorkOrderValue_ID (int MFG_WorkOrderValue_ID)
	{
		if (MFG_WorkOrderValue_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_MFG_WorkOrderValue_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_MFG_WorkOrderValue_ID, Integer.valueOf(MFG_WorkOrderValue_ID));
	}
