...
/** Generated Model for MFG_WorkOrderComponent
 *  @author Adempiere (generated) 
 *  @version Release 1.1 Supported By Cyprus - $Id$ */
public class X_MFG_WorkOrderComponent extends PO implements I_MFG_WorkOrderComponent, I_Persistent 
{
    ...
    public X_MFG_WorkOrderComponent (Properties ctx, int MFG_WorkOrderComponent_ID, String trxName)
    {
      ...
      /** if (MFG_WorkOrderComponent_ID == 0)
        {
			...
			setC_UOM_ID (0);
			setLine (0);
// @SQL=SELECT NVL(MAX(Line),0)+10 AS DefaultValue FROM MFG_WorkOrderComponent WHERE MFG_WorkOrderOperation_ID=@MFG_WorkOrderOperation_ID@
			setMFG_WorkOrderComponent_ID (0);
...
// 0
    ...
    /** Load Constructor */
    public X_MFG_WorkOrderComponent (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_MFG_WorkOrderComponent[")
	...
	public void setMFG_WorkOrderComponent_ID (int MFG_WorkOrderComponent_ID)
	{
		if (MFG_WorkOrderComponent_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_MFG_WorkOrderComponent_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_MFG_WorkOrderComponent_ID, Integer.valueOf(MFG_WorkOrderComponent_ID));
	}
    ...
    {
        return new KeyNamePair(get_ID(), String.valueOf(getMFG_WorkOrderOperation_ID()));
    }
	...
	/** SupplyType AD_Reference_ID=1000045 */
	public static final int SUPPLYTYPE_AD_Reference_ID=1000045;
	/** Assembly Pull = A */
	public static final String SUPPLYTYPE_AssemblyPull = "A";
	/** Operation Pull = O */
	public static final String SUPPLYTYPE_OperationPull = "O";
	/** Push = P */
	public static final String SUPPLYTYPE_Push = "P";
	/** Set Supply Type.
		@param SupplyType 
	...
	{
		return (String)get_Value(COLUMNNAME_SupplyType);
	}
