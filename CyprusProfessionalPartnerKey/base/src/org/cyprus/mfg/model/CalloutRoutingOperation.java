...
public class CalloutRoutingOperation extends CalloutEngine {
  ...
  public String standardOperation(Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value) {
    ...
    try {
      ...
      while (rs.next()) {
        ...
        mTab.setValue("Help", rs.getString(4));
        mTab.setValue("SetupTime", rs.getBigDecimal(5));
        mTab.setValue("UnitRuntime", rs.getBigDecimal(6));
        mTab.setValue("C_UOM_ID", Integer.valueOf(rs.getInt(7)));
        mTab.setValue("IsPermitRequired", rs.getString(8));
        mTab.setValue("IsHazardous", rs.getString(9));
      } 
      rs.close();
