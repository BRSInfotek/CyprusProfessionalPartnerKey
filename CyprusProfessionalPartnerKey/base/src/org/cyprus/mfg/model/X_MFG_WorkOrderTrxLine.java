...
/** Generated Model for MFG_WorkOrderTrxLine
 *  @author Adempiere (generated) 
 *  @version Release 1.1 Supported By Cyprus - $Id$ */
public class X_MFG_WorkOrderTrxLine extends PO implements I_MFG_WorkOrderTrxLine, I_Persistent 
{
    ...
    public X_MFG_WorkOrderTrxLine (Properties ctx, int MFG_WorkOrderTrxLine_ID, String trxName)
    {
      super (ctx, MFG_WorkOrderTrxLine_ID, trxName);
      /** if (MFG_WorkOrderTrxLine_ID == 0)
        {
			setBasisType (null);
// I
			setC_UOM_ID (0);
...
// N
    ...
    /** Load Constructor */
    public X_MFG_WorkOrderTrxLine (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_MFG_WorkOrderTrxLine[")
