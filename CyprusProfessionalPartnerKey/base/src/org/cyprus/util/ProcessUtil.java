...
import org.cyprusbrs.framework.MRule;
...
//		String sql = "{call " + ProcedureName + "(?)}";
		/// by Mukesh/Anshul @20240524.. Commented above as { } braces is not working for postgre DB. And now it will work for both DB if {} braces is removed.
		String sql = "call " + ProcedureName + "(?)";
