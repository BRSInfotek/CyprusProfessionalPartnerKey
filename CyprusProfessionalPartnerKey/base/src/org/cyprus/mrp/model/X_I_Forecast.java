...
// N
	...
	public I_MRP_ForecastLine getMRP_ForecastLine() throws RuntimeException
    {
		return (I_MRP_ForecastLine)MTable.get(getCtx(), I_MRP_ForecastLine.Table_Name)
			.getPO(getMRP_ForecastLine_ID(), get_TrxName());	}

	/** Set Forecast Line.
		@param MRP_ForecastLine_ID 
		Forecast Line
	  */
	public void setMRP_ForecastLine_ID (int MRP_ForecastLine_ID)
	{
		if (MRP_ForecastLine_ID < 1) 
			set_Value (COLUMNNAME_MRP_ForecastLine_ID, null);
		else 
			set_Value (COLUMNNAME_MRP_ForecastLine_ID, Integer.valueOf(MRP_ForecastLine_ID));
	}
	...
	public void setMRP_Forecast_ID (int MRP_Forecast_ID)
	{
		if (MRP_Forecast_ID < 1) 
			set_Value (COLUMNNAME_MRP_Forecast_ID, null);
		else 
			set_Value (COLUMNNAME_MRP_Forecast_ID, Integer.valueOf(MRP_Forecast_ID));
	}
