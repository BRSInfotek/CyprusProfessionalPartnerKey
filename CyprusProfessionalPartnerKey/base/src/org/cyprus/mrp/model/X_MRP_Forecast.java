...
public class X_MRP_Forecast extends PO implements I_MRP_Forecast, I_Persistent 
{
    ...
    public X_MRP_Forecast (Properties ctx, int MRP_Forecast_ID, String trxName)
    {
      super (ctx, MRP_Forecast_ID, trxName);
...
// N
    ...
    /** Load Constructor */
    public X_MRP_Forecast (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_MRP_Forecast[")
