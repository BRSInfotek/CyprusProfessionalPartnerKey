...
import org.cyprusbrs.framework.MBankStatement;
import org.cyprusbrs.framework.MCash;
import org.cyprusbrs.framework.MInOut;
import org.cyprusbrs.framework.MInventory;
import org.cyprusbrs.framework.MInvoice;
import org.cyprusbrs.framework.MJournal;
import org.cyprusbrs.framework.MJournalBatch;
...
//			options[index++] = DocumentEngine.ACTION_Prepare;  /// Un commented by Mukesh @20220728... Prepare was not listed for Manufacturing
			options[index++] = DocumentEngine.ACTION_Void;
		}
		//	In Process                  ..  IP
		...
		/********************
		 *  Cyprus Manufacturing Work Order by @author Mukesh 
		 */
		else if (AD_Table_ID == MMFGWorkOrder.Table_ID)
		{
			if (docStatus.equals(DocumentEngine.STATUS_Drafted)
					|| docStatus.equals(DocumentEngine.STATUS_InProgress)
					|| docStatus.equals(DocumentEngine.STATUS_Invalid))
		...
		/********************
		 *  Cyprus Manufacturing Work Order Transaction by @author Mukesh 
		 */
		else if (AD_Table_ID == MMFGWorkOrderTransaction.Table_ID)
		{
			if (docStatus.equals(DocumentEngine.STATUS_Drafted)
					|| docStatus.equals(DocumentEngine.STATUS_InProgress)
					|| docStatus.equals(DocumentEngine.STATUS_Invalid))
