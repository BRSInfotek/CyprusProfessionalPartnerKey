 ...
 */
public class AssetGroupAcctCopy extends SvrProcess
{
	/** Product Categpory			*/
	...
	protected String doIt () throws Exception
	{
		...
		*/
		String sql="UPDATE A_Asset_Group pa "
			+ " SET (A_AssetCapital_Acct,A_AccuAssetDep_Acct,A_AssetAccount,A_AssetClearing,A_AssetDep_Acct,A_AssetRevaluationRes_Acct, "
			+ " A_AssetSalesPL,A_AssetWriteOff) = "
			+ " ( SELECT A_AssetCapital_Acct,A_AccuAssetDep_Acct,A_AssetAccount,A_AssetClearing,A_AssetDep_Acct,A_AssetRevaluationRes_Acct, "
			+ " A_AssetSalesPL,A_AssetWriteOff "
			+ " FROM A_Asset_Group_Acct pca "
			+ " WHERE pca.A_Asset_Group_ID= "+ p_A_Asset_Group_ID
			+ " AND pca.C_AcctSchema_ID= "+ p_C_AcctSchema_ID
			+ " ), Updated=SysDate, UpdatedBy=0 "
			+ " WHERE pa.C_AcctSchema_ID= "+ p_C_AcctSchema_ID
			+ " AND EXISTS (SELECT * FROM A_Asset p "
			+ " WHERE p.A_Asset_ID=pa.A_Asset_ID "
			+ " AND p.A_Asset_Group_ID= "+ p_A_Asset_Group_ID+ ") ";
		...
		*/
		...
		//	Insert new Products
		sql = "INSERT INTO A_Asset_Group "
			+ "(A_Asset_ID, C_AcctSchema_ID,"
			+ " AD_Client_ID, AD_Org_ID, IsActive, Created, CreatedBy, Updated, UpdatedBy,"
			+ " A_AssetCapital_Acct, A_AccuAssetDep_Acct, A_AssetAccount, A_AssetClearing, A_AssetDep_Acct, A_AssetRevaluationRes_Acct,"
			+ " A_AssetSalesPL, A_AssetWriteOff) "
			+ "SELECT p.A_Asset_ID, acct.C_AcctSchema_ID,"
			+ " p.AD_Client_ID, p.AD_Org_ID, 'Y', SysDate, 0, SysDate, 0,"
			+ " acct.A_AssetCapital_Acct, acct.A_AccuAssetDep_Acct, acct.A_AssetAccount, acct.A_AssetClearing, acct.A_AssetDep_Acct, acct.A_AssetRevaluationRes_Acct,"
			+ " acct.A_AssetSalesPL, acct.A_AssetWriteOff"
			+ "FROM A_Asset p"
			+ " INNER JOIN A_Asset_Group_Acct acct ON (acct.A_Asset_Group_ID=p.A_Asset_Group_ID)"
			+ "WHERE acct.C_AcctSchema_ID=" + p_C_AcctSchema_ID			//	#
			+ " AND p.A_Asset_Group_ID=" + p_A_Asset_Group_ID	//	#
			+ " AND NOT EXISTS (SELECT * FROM A_Asset_Acct pa "
				+ "WHERE pa.A_Asset_ID=p.A_Asset_ID"
				+ " AND pa.C_AcctSchema_ID=acct.C_AcctSchema_ID)";
