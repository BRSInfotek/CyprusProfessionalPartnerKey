...
private Integer recordId=0;
	...
	private void createLine(MRMA mrma, MRMALine line) {
		...
		BigDecimal MovementQty = line.getQty().subtract(line.getQtyDelivered());// Updated by Anshul @20240727
		lineRet.setMovementQty(MovementQty);// Updated by Anshul @20240727
		if (!lineRet.save())
