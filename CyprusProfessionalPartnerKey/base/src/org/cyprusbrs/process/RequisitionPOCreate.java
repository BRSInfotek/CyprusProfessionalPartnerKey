...
public class RequisitionPOCreate extends SvrProcess
{
	...
	private void newOrder(MRequisitionLine rLine, int C_BPartner_ID) throws Exception
	{
		...
		// Retrieve Sales Rep from M_Requisition
		...
		if (m_order == null)
		{
			...
			m_order.setSalesRep_ID(AD_User_ID); // updated by Mukesh @20250327
	 ...
	 * 	@throws Exception
	 */
	 Set<Integer> uniquePoNumbers = new LinkedHashSet<Integer>();
	private void closeOrder() throws Exception
	{
		...
		if (m_order != null)
		{
			...
			if(!uniquePoNumbers.contains(m_order.getC_Order_ID()))
	...
	private void newLine(MRequisitionLine rLine) throws Exception
	{
		...
		// added by Mukesh @20250324
		m_orderLine.set_ValueNoCheck("C_Tax_ID", product.get_Value("C_Tax_ID"));
