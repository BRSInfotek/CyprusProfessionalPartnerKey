...
import org.cyprusbrs.framework.MDunningLevel;
import org.cyprusbrs.framework.MDunningRun;
import org.cyprusbrs.framework.MDunningRunEntry;
import org.cyprusbrs.framework.MDunningRunLine;
...
public class DunningRunCreate extends SvrProcess
{
	...
	//	log.info(sql);
		...
		finally
		{
			DB.close(rs, pstmt);
			DB.close(rs2, pstmt2);
			rs = null; rs2 = null; pstmt = null; pstmt2 = null;
		}
		return count;
	}	//	addInvoices
