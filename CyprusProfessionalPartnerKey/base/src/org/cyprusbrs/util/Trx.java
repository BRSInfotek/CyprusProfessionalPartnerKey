...
public class Trx implements VetoableChangeListener
{
	...
	/// Original Source code of Cyprus commented by Mukesh 20230613
...
/**	public synchronized boolean close()
	...
	**/
	...
	public static Trx get(String trxName) throws Exception {
		return new Trx(trxName, false);
	} // get
	
	private Trx(String trxName, boolean autoCommit) throws Exception {
		if (trxName == null || trxName.length() == 0)
			throw new IllegalArgumentException("No Transaction Name");
		m_trxName = trxName;
		try {
//			m_connection = DB.getCachedConnection();
			m_connection = DB.getConnectionID();
	...
	public static Trx getAutoCommitTrx() throws Exception {
