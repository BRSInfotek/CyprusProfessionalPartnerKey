...
import org.cyprusbrs.framework.MAssetAcct;
import org.cyprusbrs.framework.MAssetChange;
import org.cyprusbrs.framework.X_A_Asset;
import org.cyprusbrs.framework.X_A_Asset_Addition;
import org.cyprusbrs.framework.X_A_Asset_Group_Acct;
import org.cyprusbrs.framework.X_A_Depreciation_Exp;
import org.cyprusbrs.framework.X_A_Depreciation_Workfile;
import org.cyprusbrs.framework.X_C_BPartner;
import org.cyprusbrs.framework.X_C_Invoice;
import org.cyprusbrs.framework.X_C_InvoiceLine;
				...
				if (rs.getString("A_CapvsExp").equals("Cap")){
					...
					if (assetgrpacct.isProcessing()== true){					
						...
						if (DB.getSQLValue(get_TrxName(),sql2, asset.getA_Asset_ID())== 0)
					    {
							...
							try
							{
								 pstmt4 = DB.prepareStatement(sql1,get_TrxName());
