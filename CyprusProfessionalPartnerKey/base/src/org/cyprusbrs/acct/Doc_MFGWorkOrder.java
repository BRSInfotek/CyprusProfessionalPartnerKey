...
public class Doc_MFGWorkOrder extends Doc {
  private MMFGWorkOrder m_workorder;
  
  public Doc_MFGWorkOrder(MAcctSchema[] ass, ResultSet rs, String trx) {
  ...
  //  } 
    ...
    if (mfgCostElement != 0 && StandardCostElement.getM_CostElement_ID() != 0) {
      ...
      drAcct = getAccount(ACCTTYPE_WorkOrderMaterialVariance, as);
...
//          drAcct = getAccount(7673, as);
          crAcct = getAccount(ACCTTYPE_WorkCenterOverhead, as);
          drAcct = getAccount(ACCTTYPE_WorkOrderOverheadVariance, as);
...
//          drAcct = getAccount(7674, as);
          ...
          drAcct = getAccount(ACCTTYPE_WorkOrderResrouceVariance, as);
