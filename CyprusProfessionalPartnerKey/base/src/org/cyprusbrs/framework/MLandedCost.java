...
//		}
	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		//code update by Anshul @20250212
			int no = DB.executeUpdate("UPDATE C_InvoiceLine SET IsLandedCost='Y' WHERE C_InvoiceLine_ID=" + getC_InvoiceLine_ID(), get_TrxName());
			// end of code update by Anshul @20250212
