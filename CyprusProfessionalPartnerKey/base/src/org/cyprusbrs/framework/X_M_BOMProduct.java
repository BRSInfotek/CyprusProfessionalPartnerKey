...
import org.cyprus.mfg.model.X_Ref_M_BOMProduct_SupplyType;
...
// @SQL=SELECT NVL(MAX(Line),0)+10 AS DefaultValue FROM M_BOMProduct WHERE M_BOM_ID=@M_BOM_ID@
	...
	public int getOperationSeqNo() {
	 ...
	 public void setM_ProductBOMVersion_ID(int M_ProductBOMVersion_ID) {
		    if (M_ProductBOMVersion_ID <= 0) {
		      set_Value("M_ProductBOMVersion_ID", null);
		    } else {
		  ...
		  public void setSupplyType(String SupplyType) {
		    if (SupplyType == null)
		      throw new IllegalArgumentException("SupplyType is mandatory"); 
