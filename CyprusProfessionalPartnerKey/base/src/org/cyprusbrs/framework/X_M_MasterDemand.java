...
/** Generated Model for M_MasterDemand
 *  @author Adempiere (generated) 
 *  @version Release 1.0 Supported By Cyprus ERP - $Id$ */
public class X_M_MasterDemand extends PO implements I_M_MasterDemand, I_Persistent 
{
    ...
    public X_M_MasterDemand (Properties ctx, int M_MasterDemand_ID, String trxName)
    {
      super (ctx, M_MasterDemand_ID, trxName);
      /** if (M_MasterDemand_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_M_MasterDemand (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_M_MasterDemand[")
	...
	/** Set Master Demand.
		@param M_MasterDemand_ID Master Demand	  */
	@Override
