...
public class CalloutBankStatement extends CalloutEngine
{
	...
	public String openingBalance (Properties ctx, int WindowNo, GridTab mTab, GridField mField, Object value)
	{
		if (isCalloutActive())		//	assuming it is resetting value
			return "";
		BigDecimal openingAmount = (BigDecimal)mTab.getValue(I_C_BankAccount.COLUMNNAME_OpeningBalance);
		mTab.setValue(I_C_BankAccount.COLUMNNAME_CurrentBalance, openingAmount);
		return "";
	}
