...
public class MRMA extends X_M_RMA implements DocAction
{
	...
	public MRMALine[] getLines (boolean requery)
	{
		...
		.setOrderBy(I_M_RMALine.COLUMNNAME_Line)
		.list();
	...
	public int copyLinesFrom (MRMA otherRMA, boolean counter)
	{
		...
		for (int i = 0; i < fromLines.length; i++)
		{
			...
			line.set_ValueNoCheck (I_M_RMALine.COLUMNNAME_M_RMALine_ID, I_ZERO);	//	new
			if (counter)
			{
    ...
    public MRMALine[] getChargeLines()
    {
        ...
        int rmaLineIds[] = PO.getAllIDs(I_M_RMALine.Table_Name, whereClause.toString(), get_TrxName());
