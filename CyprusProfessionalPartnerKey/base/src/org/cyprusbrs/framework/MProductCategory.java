...
//		}
	 ...
	 */
	public static MProductCategory getOfProduct (Properties ctx, int M_Product_ID)
	{
...
//		}
	 ...
	 * @return
	 */
	public MProduct[] getProductsofCategory(String WhereClause, String trx) {
	    ...
	    String stmt = role.addAccessSQL(sql.toString(), "M_Product", false, false);
	    PreparedStatement pstmt = null;
	    ResultSet rs = null;
	    try {
	      cPreparedStatement = DB.prepareStatement(stmt, trx);
	      cPreparedStatement.setInt(1, getM_Product_Category_ID());
