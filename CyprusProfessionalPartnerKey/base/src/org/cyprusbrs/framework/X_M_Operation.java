...
public class X_M_Operation extends PO implements I_M_Operation, I_Persistent 
{
    ...
    public X_M_Operation (Properties ctx, int M_Operation_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_M_Operation (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_M_Operation[")
