...
public class MRequest extends X_R_Request
{
	...
	{
		final String whereClause = I_R_RequestAction.COLUMNNAME_R_Request_ID+"=?";
	...
	{
		final String whereClause = I_R_RequestUpdate.COLUMNNAME_R_Request_ID+"=?";
		...
		//			continue;
					...
					|| X_AD_User.NOTIFICATIONTYPE_EMailPlusNotice.equals(NotificationType))
				{
					...
					MNote note = new MNote(getCtx(), AD_Message_ID, AD_User_ID,
						I_R_Request.Table_ID, getR_Request_ID(), 
