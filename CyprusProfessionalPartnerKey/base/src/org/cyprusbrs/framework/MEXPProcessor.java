...
public class MEXPProcessor extends X_EXP_Processor {
	...
	public X_EXP_ProcessorParameter[] getEXP_ProcessorParameters(String trxName) {
		...
		StringBuffer sql = new StringBuffer("SELECT * ")
			.append(" FROM ").append(I_EXP_ProcessorParameter.Table_Name)
			.append(" WHERE ").append(I_EXP_ProcessorParameter.COLUMNNAME_EXP_Processor_ID).append("=?") // # 1
		...
		X_EXP_ProcessorParameter[] result = resultList.toArray( new X_EXP_ProcessorParameter[0]);
		parameters = result;
		return result;
	}
