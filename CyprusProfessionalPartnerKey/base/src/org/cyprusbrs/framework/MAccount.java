...
public class MAccount extends X_C_ValidCombination
{
	...
	{
		List<MAccount> accounts=  new Query(ctx,I_C_ValidCombination.Table_Name,where,trxName)
		.setOrderBy(I_C_ValidCombination.COLUMNNAME_C_ValidCombination_ID).list();
