...
public class MMovementLine extends X_M_MovementLine
{
	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		{
			if (   X_M_Movement.DOCACTION_Void.equals(getParent().getDocAction())
				&& (   X_M_Movement.DOCSTATUS_Drafted.equals(getParent().getDocStatus())
					|| X_M_Movement.DOCSTATUS_Invalid.equals(getParent().getDocStatus())
					|| X_M_Movement.DOCSTATUS_InProgress.equals(getParent().getDocStatus())
					|| X_M_Movement.DOCSTATUS_Approved.equals(getParent().getDocStatus())
					|| X_M_Movement.DOCSTATUS_NotApproved.equals(getParent().getDocStatus())
				   )
				) 
			{
