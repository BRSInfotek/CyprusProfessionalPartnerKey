...
import org.cyprusbrs.model.PaymentProcessor;
	...
	implements DocAction, ProcessCall
{
	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		if(get_ValueAsBigDecimal("WithholdingTaxAmt").compareTo(Env.ZERO) > 0)
		{
			set_Value("IsTDSDeduction", "Y");
		}
		...
		if (getC_Charge_ID() != 0) 
		{
			...
			if ((newRecord || is_ValueChanged("C_Charge_ID")) && !ch.get_ValueAsBoolean("IsAdvanceCharge"))
			{
				setC_Order_ID(0);
				setC_Invoice_ID(0);
				setWriteOffAmt(Env.ZERO);
