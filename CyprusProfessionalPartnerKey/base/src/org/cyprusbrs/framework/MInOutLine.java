...
public class MInOutLine extends X_M_InOutLine
{
	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		String sqlQua = "SELECT dt.IsQualityCheck FROM C_DocType dt "
				+ "JOIN M_InOut io on io.C_DocType_ID=dt.C_DocType_ID "
				+ "WHERE io.M_InOut_ID=?";
		String IsQualityCheck = DB.getSQLValueString(null, sqlQua, getM_InOut_ID());
		if("Y".equalsIgnoreCase(IsQualityCheck))
		{
			QualityResultUtility.saveQualityResult("MR", getM_InOutLine_ID(), getM_Product_ID());
		}
