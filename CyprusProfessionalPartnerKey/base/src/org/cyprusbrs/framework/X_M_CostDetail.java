...
import org.cyprus.mfg.model.I_MFG_WorkOrderResTxnLine;
...
//	}
	...
	@Override
	public I_MFG_WorkOrderResTxnLine getMFG_WorkOrderResTxnLine() throws RuntimeException
    {
		return (I_MFG_WorkOrderResTxnLine)MTable.get(getCtx(), I_MFG_WorkOrderResTxnLine.Table_Name)
			.getPO(getMFG_WorkOrderResTxnLine_ID(), get_TrxName());	}
	...
	public void setMFG_WorkOrderResTxnLine_ID (int MFG_WorkOrderResTxnLine_ID)
	{
		if (MFG_WorkOrderResTxnLine_ID < 1) 
			set_Value (COLUMNNAME_MFG_WorkOrderResTxnLine_ID, null);
		else 
			set_Value (COLUMNNAME_MFG_WorkOrderResTxnLine_ID, Integer.valueOf(MFG_WorkOrderResTxnLine_ID));
	}
