...
public class X_M_MatchPO extends PO implements I_M_MatchPO, I_Persistent 
{
	...
	@Override
	public void setTrxCost(BigDecimal TransactionCost)
	{
		set_Value (COLUMNNAME_TrxCost, TransactionCost);
	}

	/** Get TransactionCost.
		@return TransactionCost of the record
	  */
	@Override
	...
	{
		set_Value (COLUMNNAME_POCost, POCost);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_POCost);
		if (bd == null)
			 return Env.ZERO;
		return bd;
