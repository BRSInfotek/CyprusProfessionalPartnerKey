...
//		if (getKeepLogDays() < 1)
//			return no;
//		String sqlmax = "select count(*) from R_RequestProcessorLog where R_RequestProcessor_ID=" + getR_RequestProcessor_ID() +" and created < (sysdate-" + getKeepLogDays() + ")";
//		int count = DB.getSQLValueEx(get_TrxName(), sqlmax);
//		log.info("No. of count for request processor = " + count );
//		if(count > 1400)
//		{
//			String sql = "DELETE R_RequestProcessorLog"
//					+ " where R_RequestProcessor_ID=" + getR_RequestProcessor_ID() + " and  created < (sysdate-" + getKeepLogDays() + ")";				
//		 no = DB.executeUpdateEx(sql, get_TrxName());
//		 log.info("No. of delete records for request processor = " + no);
//		}
//		else
//		{
//			no = 0;
