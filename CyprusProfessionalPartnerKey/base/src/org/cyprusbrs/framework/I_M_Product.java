...
public interface I_M_Product 
{
	...
	/** Column name IsPlannedItem */
	public static final String COLUMNNAME_IsPlannedItem = "IsPlannedItem";

	/** Set Planned Item.
	 * Indicates if the product is available for planning in Compiere MRP
	 */
	...
	/** Column name ManufactureTime_Expected */
	public static final String COLUMNNAME_ManufactureTime_Expected = "ManufactureTime_Expected";
	...
	public static final String COLUMNNAME_BatchSize = "BatchSize";
	...
	/** Column name IsPurchasedToOrder */
	public static final String COLUMNNAME_IsPurchasedToOrder = "IsPurchasedToOrder";
	...
	public static final String COLUMNNAME_ResourceGroup = "ResourceGroup";
    ...
    public static final String COLUMNNAME_IsTaxRule = "IsTaxRule";
