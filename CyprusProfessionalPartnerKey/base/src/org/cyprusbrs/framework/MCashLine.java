...
public class MCashLine extends X_C_CashLine
{
	...
	public void setInvoice (MInvoice invoice)
	{
		...
		if (X_C_DocType.DOCBASETYPE_APInvoice.equals(dt.getDocBaseType())
	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		**/
		...
		if ((newRecord || is_ValueChanged(I_C_CashLine.COLUMNNAME_Amount)))	//	allow different org for charge
...
//		if(getAmount().compareTo(Env.ZERO) != 0 || is_ValueChanged(MCashLine.COLUMNNAME_C_Tax_ID))
		if(getCashType() == "C" || is_ValueChanged(I_C_CashLine.COLUMNNAME_C_Tax_ID))
		{
