	...
	implements CyprusProcessor, CyprusProcessor2
{
	...
	{
		final String whereClause = I_AD_SchedulerLog.COLUMNNAME_AD_Scheduler_ID+"=?";
	...
	public MSchedulerPara[] getParameters (boolean reload)
	{
		if (!reload && m_parameter != null)
			return m_parameter;
		//
		final String whereClause = I_AD_Scheduler_Para.COLUMNNAME_AD_Scheduler_ID+"=?";
	...
	public MSchedulerRecipient[] getRecipients (boolean reload)
	{
		if (!reload && m_recipients != null)
			return m_recipients;
		//
		final String whereClause = I_AD_SchedulerRecipient.COLUMNNAME_AD_Scheduler_ID+"=?";
