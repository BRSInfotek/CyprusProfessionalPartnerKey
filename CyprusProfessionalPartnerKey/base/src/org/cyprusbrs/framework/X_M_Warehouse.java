...
// *
	...
	@Override
	public I_M_Locator getM_RcvLocator() throws RuntimeException
    {
		return (I_M_Locator)MTable.get(getCtx(), I_M_Locator.Table_Name)
			.getPO(getM_RcvLocator_ID(), get_TrxName());	}

	/** Set Receiving Locator.
		@param M_RcvLocator_ID 
		Default Locator used in quick receiving windows
	  */
	@Override
	public void setM_RcvLocator_ID (int M_RcvLocator_ID)
	{
		if (M_RcvLocator_ID < 1) 
			set_Value (COLUMNNAME_M_RcvLocator_ID, null);
		else 
			set_Value (COLUMNNAME_M_RcvLocator_ID, Integer.valueOf(M_RcvLocator_ID));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_M_RcvLocator_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	public void setIsDisallowNegativeInv(boolean IsDisallowNegativeInv) {
	  ...
	  public boolean isDisallowNegativeInv() {
		...
		/** Set WMS Enabled.
		@param IsWMSEnabled 
		Is this warehouse WMS enabled
	  */
	@Override
	public void setIsWMSEnabled (boolean IsWMSEnabled)
	{
		set_Value (COLUMNNAME_IsWMSEnabled, Boolean.valueOf(IsWMSEnabled));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_IsWMSEnabled);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
