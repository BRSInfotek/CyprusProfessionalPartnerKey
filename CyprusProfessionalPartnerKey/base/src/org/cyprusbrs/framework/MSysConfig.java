	...
	protected boolean beforeSave (boolean newRecord)
	{
		...
		if (getAD_Client_ID() != 0 || getAD_Org_ID() != 0) {
			...
			if (configLevel != null) {
				...
				if (getAD_Org_ID() != 0 && 
						(configLevel.equals(X_AD_SysConfig.CONFIGURATIONLEVEL_System) || 
						 configLevel.equals(X_AD_SysConfig.CONFIGURATIONLEVEL_Client))) {
				...
				if (getAD_Client_ID() != 0 && configLevel.equals(X_AD_SysConfig.CONFIGURATIONLEVEL_System)) {
				...
				else if (getAD_Client_ID() != 0 && getConfigurationLevel().equals(X_AD_SysConfig.CONFIGURATIONLEVEL_System))
