...
public class X_C_AcctSchema extends PO implements I_C_AcctSchema, I_Persistent 
{
	 ...
	 *
	 */
	private static final long serialVersionUID = 20240713L;
...
// -
	...
	/** Set Post PO Variance.
		@param IsPostPOVariance Post PO Variance	  */
	@Override
	public void setIsPostPOVariance (boolean IsPostPOVariance)
	{
		set_Value (COLUMNNAME_IsPostPOVariance, Boolean.valueOf(IsPostPOVariance));
	}

	/** Get Post PO Variance.
		@return Post PO Variance	  */
	@Override
	public boolean isPostPOVariance () 
	{
		Object oo = get_Value(COLUMNNAME_IsPostPOVariance);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
