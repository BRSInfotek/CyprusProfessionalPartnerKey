	...
	implements CyprusProcessor 
{
	...
	public CyprusProcessorLog[] getLogs ()
	{
		...
		String sql = "SELECT * "
			+ "FROM " + I_IMP_ProcessorLog.Table_Name + " "
			+ "WHERE " + I_IMP_Processor.COLUMNNAME_IMP_Processor_ID + "=? " // # 1 
...
//		}
	...
	public int deleteLog()
	{
		if (getKeepLogDays() < 1)
			return 0;
		String sql = "DELETE " + I_IMP_ProcessorLog.Table_Name + " "
			+ "WHERE "+I_IMP_ProcessorLog.COLUMNNAME_IMP_Processor_ID+"=" + getIMP_Processor_ID() 
	...
	public X_IMP_ProcessorParameter[] getIMP_ProcessorParameters(String trxName) {
		...
		StringBuffer sql = new StringBuffer("SELECT * ")
			.append(" FROM ").append(I_IMP_ProcessorParameter.Table_Name)
			.append(" WHERE ").append(I_IMP_ProcessorParameter.COLUMNNAME_IMP_Processor_ID).append("=?") // # 1
	...
	public static MIMPProcessor[] getActive(Properties ctx)
	{
		...
		String sql = "SELECT * FROM "+I_IMP_Processor.Table_Name+" WHERE IsActive='Y'";
		PreparedStatement pstmt = null;
		ResultSet rs  = null;
		try
		{
