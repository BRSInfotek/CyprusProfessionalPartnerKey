...
public class MEXPFormatLine extends X_EXP_FormatLine {
	...
	StringBuffer sql = new StringBuffer("SELECT * ")
		.append(" FROM ").append(I_EXP_FormatLine.Table_Name)
		.append(" WHERE ").append(I_EXP_Format.COLUMNNAME_Value).append("=?")
		//.append(" AND IsActive = ?")
		//.append(" AND AD_Client_ID = ?")
		.append(" AND ").append(I_EXP_Format.COLUMNNAME_EXP_Format_ID).append(" = ?")
	;
