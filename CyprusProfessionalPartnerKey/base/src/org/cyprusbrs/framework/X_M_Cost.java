...
public class X_M_Cost extends PO implements I_M_Cost, I_Persistent 
{
	...
	public boolean isProcessed () 
	{
	 ...
	 /** BasisType AD_Reference_ID=1000034 */
		...
		public static final int ISTHISLEVEL_AD_Reference_ID=319;
		/** Yes = Y */
		public static final String ISTHISLEVEL_Yes = "Y";
		/** No = N */
		public static final String ISTHISLEVEL_No = "N";
		/** Set This Level.
			@param IsThisLevel 
			Indicates if the product assembly cost is a result of direct costs or manufacturing costs from component and resource requirements.
		  */
		@Override
		public void setIsThisLevel (String IsThisLevel)
		{

			set_Value (COLUMNNAME_IsThisLevel, IsThisLevel);
		}
		...
		{
			return (String)get_Value(COLUMNNAME_IsThisLevel);
		}
		
	 /**
	  * Updated by @author Mukesh For Manufactring module 20220810	
	  */
	  ...
	  public void setIsUserDefined1(String IsUserDefined) {
	    if (IsUserDefined == null)
	      throw new IllegalArgumentException("IsUserDefined is mandatory"); 
  ...
  /// Added by Mukesh @20221102
  @Override
public void setIsUserDefined (String IsUserDefined)
	{
	  	if("Y".equals(IsUserDefined))
		set_Value (COLUMNNAME_IsUserDefined, true);
	  	else
	  	set_Value (COLUMNNAME_IsUserDefined, false);
	}
  @Override
public String getIsUserDefined () 
	{
	  Object oo = get_Value(COLUMNNAME_IsUserDefined);
		if (oo != null) 
		{
			 if (oo instanceof Boolean && (Boolean)oo) 
			return "Y";
		}
		return "N";
	}
