...
public class MEXPFormat extends X_EXP_Format {
	...
	public List<MEXPFormatLine> getFormatLinesOrderedBy(String orderBy) 
	{
		...
		final String clauseWhere = I_EXP_FormatLine.COLUMNNAME_EXP_Format_ID + "=?";	
			...
			throws SQLException 
	{
		...
		StringBuffer whereClause = new StringBuffer(I_EXP_Format.COLUMNNAME_Value).append("=?")
		.append(" AND AD_Client_ID = ?")
		.append(" AND ").append(I_EXP_Format.COLUMNNAME_Version).append(" = ?");

		retValue = (MEXPFormat) new Query(ctx,I_EXP_Format.Table_Name,whereClause.toString(),trxName)
	...
	public static MEXPFormat getFormatByAD_Client_IDAD_Table_IDAndVersion(Properties ctx, int AD_Client_ID, int AD_Table_ID, String version, String trxName) throws SQLException 
	{
		...
		StringBuffer whereClause = new StringBuffer(" AD_Client_ID = ? ")
			.append("  AND ").append(I_EXP_Format.COLUMNNAME_AD_Table_ID).append(" = ? ")
			.append("  AND ").append(I_EXP_Format.COLUMNNAME_Version).append(" = ?");
	...
	{
		int[] ids =PO.getAllIDs(I_EXP_FormatLine.Table_Name, "EXP_Format_ID="+getEXP_Format_ID(), get_TrxName());
		for (int id : ids)
		{
