...
public class MBOM extends X_M_BOM
{
	 ...
	 */
	public static MBOM[] getBOMLines (MProduct product)
	{
	 ...
	 *	@return array of BOMs
	 */
	public static MBOM[] getBOMLines (Properties ctx, int M_Product_ID, String trxName)
	{
 		//FR: [ 2214883 ] Remove SQL code and Replace for Query - red1
		final String whereClause = "M_Product_ID=?";
		List <MBOM> list = new Query(ctx, I_M_BOM.Table_Name, whereClause, trxName)
