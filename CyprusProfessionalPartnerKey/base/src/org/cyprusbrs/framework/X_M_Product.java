...
// I
	...
	/// Added from Compiere by @Mukesh @20220810
	...
	{
		set_Value (COLUMNNAME_IsPlannedItem, Boolean.valueOf(IsPlannedItem));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_IsPlannedItem);
		if (oo != null) 
		{
			if (oo instanceof Boolean) 
				return ((Boolean)oo).booleanValue(); 
	...
	@param ManufactureTime_Expected 
	Expected number of days required to manufacture the product
	 */
	@Override
	public void setManufactureTime_Expected (int ManufactureTime_Expected)
	{
		set_Value (COLUMNNAME_ManufactureTime_Expected, Integer.valueOf(ManufactureTime_Expected));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_ManufactureTime_Expected);
		if (ii == null)
			return 0;
		return ii.intValue();
	}
	...
	Indicates if the product is manufactured
	 */
	@Override
	...
	/** Set BatchSize.
	@param BatchSize 
	Number of items in a batch for the product
	 */
	@Override
	public void setBatchSize (int BatchSize)
	{
		set_Value (COLUMNNAME_BatchSize, Integer.valueOf(BatchSize));
	}
	...
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_BatchSize);
		if (ii == null)
			return 0;
		return ii.intValue();
	}
...
Products that are usually not kept in stock, but are purchased whenever there is a demand
	...
	{
		set_Value (COLUMNNAME_IsPurchasedToOrder, Boolean.valueOf(IsPurchasedToOrder));
	}
...
@return Products that are usually not kept in stock, but are purchased whenever there is a demand
	...
	{
		Object oo = get_Value(COLUMNNAME_IsPurchasedToOrder);
		if (oo != null) 
		{
			if (oo instanceof Boolean) 
				return ((Boolean)oo).booleanValue(); 
	...
	//updated by anshul 06-12-2022

	/** ResourceGroup AD_Reference_ID=1000056 */
	public static final int RESOURCEGROUP_AD_Reference_ID=1000056;
	/** Equipment = E */
	public static final String RESOURCEGROUP_Equipment = "E";
	/** Other = O */
	public static final String RESOURCEGROUP_Other = "O";
	/** Person = P */
	public static final String RESOURCEGROUP_Person = "P";
	/** Set Resource Group.
	@param ResourceGroup 
	First level grouping of resources into Person, Equipment or Other.
	 */
	@Override
	public void setResourceGroup (String ResourceGroup)
	{

		set_Value (COLUMNNAME_ResourceGroup, ResourceGroup);
	}
	...
	{
		return (String)get_Value(COLUMNNAME_ResourceGroup);
	}
	@Override
	...
	@Override
	public void setIsTaxRule (boolean IsTaxRule)
	{
		set_Value (COLUMNNAME_IsTaxRule, Boolean.valueOf(IsTaxRule));
	}

	
	@Override
	public boolean IsTaxRule () 
	{
		Object oo = get_Value(COLUMNNAME_IsTaxRule);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
