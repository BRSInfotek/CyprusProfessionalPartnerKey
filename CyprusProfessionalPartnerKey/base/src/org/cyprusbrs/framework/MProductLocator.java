...
//		}
	 ...
	 */
	public static MProductLocator getOfProductLocator(Properties ctx, int M_Product_ID, int M_Locator_ID)
	{
...
//		}
	 ...
	 *	@param trx p_trx
	 */
	public MProductLocator(Properties ctx, ResultSet rs, String trx)
	{
		super (ctx, rs, trx);
	}	//	MProductLocator
	
	public MProductLocator(Properties ctx, int M_Product_ID, int M_Locator_ID, String trx)
	{
		super(ctx, 0, trx);
	...
	protected boolean beforeSave(boolean newRecord) 
	{
		...
		{
			int ii = DB.getSQLValue(get_TrxName(), "SELECT count(*) " +
