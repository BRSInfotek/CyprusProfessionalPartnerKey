...
//		}
	...
	public static String getCounterDocBaseType (String DocBaseType)
	{
		...
		//	SO/PO
		if (X_C_DocType.DOCBASETYPE_SalesOrder.equals(DocBaseType))
			retValue = X_C_DocType.DOCBASETYPE_PurchaseOrder;
		else if (X_C_DocType.DOCBASETYPE_PurchaseOrder.equals(DocBaseType))
			retValue = X_C_DocType.DOCBASETYPE_SalesOrder;
		//	AP/AR Invoice
		else if (X_C_DocType.DOCBASETYPE_APInvoice.equals(DocBaseType))
			retValue = X_C_DocType.DOCBASETYPE_ARInvoice;
		else if (X_C_DocType.DOCBASETYPE_ARInvoice.equals(DocBaseType))
			retValue = X_C_DocType.DOCBASETYPE_APInvoice;
		//	Shipment
		else if (X_C_DocType.DOCBASETYPE_MaterialDelivery.equals(DocBaseType))
			retValue = X_C_DocType.DOCBASETYPE_MaterialReceipt;
		else if (X_C_DocType.DOCBASETYPE_MaterialReceipt.equals(DocBaseType))
			retValue = X_C_DocType.DOCBASETYPE_MaterialDelivery;
		//	AP/AR CreditMemo
		else if (X_C_DocType.DOCBASETYPE_APCreditMemo.equals(DocBaseType))
			retValue = X_C_DocType.DOCBASETYPE_ARCreditMemo;
		else if (X_C_DocType.DOCBASETYPE_ARCreditMemo.equals(DocBaseType))
			retValue = X_C_DocType.DOCBASETYPE_APCreditMemo;
		//	Receipt / Payment
		else if (X_C_DocType.DOCBASETYPE_ARReceipt.equals(DocBaseType))
			retValue = X_C_DocType.DOCBASETYPE_APPayment;
		else if (X_C_DocType.DOCBASETYPE_APPayment.equals(DocBaseType))
			retValue = X_C_DocType.DOCBASETYPE_ARReceipt;
		//
		else
	...
	public String validate()
	{
		...
		//	SO / PO
		if ((X_C_DocType.DOCBASETYPE_SalesOrder.equals(dtBT) && X_C_DocType.DOCBASETYPE_PurchaseOrder.equals(c_dtBT))
			|| (X_C_DocType.DOCBASETYPE_SalesOrder.equals(c_dtBT) && X_C_DocType.DOCBASETYPE_PurchaseOrder.equals(dtBT))) 
			setIsValid(true);
		//	AP/AR Invoice
		else if ((X_C_DocType.DOCBASETYPE_APInvoice.equals(dtBT) && X_C_DocType.DOCBASETYPE_ARInvoice.equals(c_dtBT))
			|| (X_C_DocType.DOCBASETYPE_APInvoice.equals(c_dtBT) && X_C_DocType.DOCBASETYPE_ARInvoice.equals(dtBT))) 
			setIsValid(true);
		//	Shipment
		else if ((X_C_DocType.DOCBASETYPE_MaterialDelivery.equals(dtBT) && X_C_DocType.DOCBASETYPE_MaterialReceipt.equals(c_dtBT))
			|| (X_C_DocType.DOCBASETYPE_MaterialDelivery.equals(c_dtBT) && X_C_DocType.DOCBASETYPE_MaterialReceipt.equals(dtBT))) 
			setIsValid(true);
		//	AP/AR CreditMemo
		else if ((X_C_DocType.DOCBASETYPE_APCreditMemo.equals(dtBT) && X_C_DocType.DOCBASETYPE_ARCreditMemo.equals(c_dtBT))
			|| (X_C_DocType.DOCBASETYPE_APCreditMemo.equals(c_dtBT) && X_C_DocType.DOCBASETYPE_ARCreditMemo.equals(dtBT))) 
			setIsValid(true);
		//	Receipt / Payment
		else if ((X_C_DocType.DOCBASETYPE_ARReceipt.equals(dtBT) && X_C_DocType.DOCBASETYPE_APPayment.equals(c_dtBT))
			|| (X_C_DocType.DOCBASETYPE_ARReceipt.equals(c_dtBT) && X_C_DocType.DOCBASETYPE_APPayment.equals(dtBT))) 
			setIsValid(true);
		else
		{
