...
public class MProcess extends X_AD_Process
{
	...
	private static final CLogger log = CLogger.getCLogger(MProcess.class);
	...
	public static MProcess getUsingJavaClass(final Class<?> processClass)
	{
		...
		return new Query(Env.getCtx() , I_AD_Process.Table_Name , I_AD_Process.COLUMNNAME_Classname + "=?" , null)
	...
	public MProcessPara[] getParameters()
	{
		if (m_parameters != null)
			return m_parameters;
		//
		final String whereClause = I_AD_Process_Para.COLUMNNAME_AD_Process_ID+"=?";
	...
	public List<MProcessPara> getParametersAsList(String optionalWhereClause) {
		StringBuffer whereClause = new StringBuffer(I_AD_Process_Para.COLUMNNAME_AD_Process_ID + "=?");
	 ...
	 *	@return MProcess or null
	 */
	// implemented by @Anshul 15122021 as per instructed by mukesh
	public static int getIDByValue (Properties ctx, String value)
	{
		int retValue = -1;
