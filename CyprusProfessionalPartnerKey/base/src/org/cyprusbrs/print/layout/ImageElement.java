...
import org.cyprusbrs.framework.I_AD_PrintFormatItem;
import org.cyprusbrs.framework.MAttachment;
import org.cyprusbrs.framework.MImage;
import org.cyprusbrs.framework.X_AD_PrintFormatItem;
...
public class ImageElement extends PrintElement
{
	...
	private void loadAttachment(int AD_PrintFormatItem_ID)
	{
		MAttachment attachment = MAttachment.get(Env.getCtx(), 
			I_AD_PrintFormatItem.Table_ID, AD_PrintFormatItem_ID);
		if (attachment == null)
		{
