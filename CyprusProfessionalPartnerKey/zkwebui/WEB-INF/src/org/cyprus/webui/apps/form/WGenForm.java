...
public class WGenForm extends ADForm implements EventListener, WTableModelListener
{
	...
	{
		String manuFact=genForm.generateManufacturing();
		info.setContent(manuFact);
		
		StringBuffer iText = new StringBuffer();
		iText.append("<b>").append("Generated Manufacturing "+manuFact)
			.append("</b><br>(")
	...
	public void generateCostCollector()
	{
		String manuFact=genForm.generateCostCollector();
		info.setContent(manuFact);
		
		StringBuffer iText = new StringBuffer();
		iText.append("<b>").append(manuFact)
			.append("</b><br>")
			.append(Msg.getMsg(Env.getCtx(), genForm.getTitle()))
			.append("<br>");
		info.setContent(iText.toString());
