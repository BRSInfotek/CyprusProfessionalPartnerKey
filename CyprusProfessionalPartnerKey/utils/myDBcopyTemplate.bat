...
@Rem		%CYPRUS_HOME%\data\ExpDat.dmp
@Rem		%CYPRUS_HOME%\data\ExpDat.log
@Rem		%CYPRUS_HOME%\data\ExpDat.jar (containing the above)
...
@Echo copy %CYPRUS_HOME%\data\ExpDat%DATETIME%.jar to backup media
